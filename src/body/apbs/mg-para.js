  ...
  renderGridPointsDomain(){
    return(
      <Col offset={2}>
        ...
        <Row gutter={16} style={{marginBottom: 8}}>
          <Col  span={5}>{this.renderNumericalField('X-direction','dimenx', this.state.dimenx)}</Col>
          <Col  span={5}>{this.renderNumericalField('X-direction','cglenx', this.state.cglenx)}</Col>
          <Col  span={5}>{this.renderNumericalField('X-direction','fglenx', this.state.fglenx)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','pdimex', this.state.pdimex)}</Col>
        </Row>
        
        <Row gutter={16} style={{marginBottom: 8}}>
          <Col  span={5}>{this.renderNumericalField('Y-direction','dimeny', this.state.dimeny)}</Col>
          <Col  span={5}>{this.renderNumericalField('Y-direction','cgleny', this.state.cgleny)}</Col>
          <Col  span={5}>{this.renderNumericalField('Y-direction','fgleny', this.state.fgleny)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','pdimey', this.state.pdimey)}</Col>
        </Row>

        <Row gutter={16} style={{marginBottom: 8}}>
          <Col  span={5}>{this.renderNumericalField('Z-direction','dimenz', this.state.dimenz)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','cglenz', this.state.cglenz)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','fglenz', this.state.fglenz)}</Col>
          <Col  span={5}>{this.renderNumericalField('Z-direction','pdimez', this.state.pdimez)}</Col>
        </Row>
        ...
        <Col>
          <Collapse activeKey={this.state.collapse_active_keys} onChange={this.updateCollapseActiveKeys}>
            ...
            <Panel forceRender={true} header="AMOUNT OF OVERLAP TO INCLUDE BETWEEN THE INDIVIDUAL PROCESSORS' MESHES">
              <Col span={4}> {this.renderNumericalField('', 'ofrac', this.state.ofrac)} </Col>
            </Panel>
